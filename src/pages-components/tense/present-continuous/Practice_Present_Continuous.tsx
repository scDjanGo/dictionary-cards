...
export default function Practice_Present_Continuous() {
  const [showAnswers, setShowAnswers] = useState(false);
  const [answers, setAnswers] = useState<{ [key: number]: string }>({});

  const questions = [
    {
      q: "I ___ reading a book right now.",
      options: ["am", "is", "are"],
      correct: "am",
    },
    {
    ...
    {
      q: "They ___ playing football outside.",
      options: ["am", "is", "are"],
      correct: "are",
    },
    {
      q: "We ___ studying for the test.",
      options: ["am", "is", "are"],
      correct: "are",
    },
    {
