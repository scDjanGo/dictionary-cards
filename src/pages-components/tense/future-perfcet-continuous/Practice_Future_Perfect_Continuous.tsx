...
export default function Practice_Future_Perfect_Continuous() {
  const [showAnswers, setShowAnswers] = useState(false);
  const [answers, setAnswers] = useState<{ [key: number]: string }>({});

  const questions = [
    {
      q: "I ___ been studying for three hours by 8 pm tomorrow.",
      options: ["will have", "will have been", "have been"],
      correct: "will have been",
    },
    {
      q: "She ___ been working here for five years by next month.",
      options: ["will have", "will have been", "has been"],
      correct: "will have been",
    },
    {
      q: "They ___ been playing football for two hours by the time we arrive.",
      options: ["will have", "will have been", "have been"],
      correct: "will have been",
    },
    {
      q: "We ___ been learning English for three years by the end of this course.",
      options: ["will have", "will have been", "have been"],
      correct: "will have been",
    },
    {
      q: "He ___ been talking on the phone for 30 minutes by the time I get home.",
      options: ["will have", "will have been", "has been"],
      correct: "will have been",
    },
  ];
  ...
  return (
    <section>
      <h2 className="text-2xl font-semibold mb-2 text-blueCl">
        ✍️ Практика — Future Perfect Continuous
      </h2>
      <p className="dark:text-bgLight/70 mb-4">
        Выбери правильную форму <b>will have been</b> для времени <b>Future Perfect Continuous</b>:
      </p>
