...
export default function Practice_Present_Perfect_Continuous() {
  const [showAnswers, setShowAnswers] = useState(false);
  const [answers, setAnswers] = useState<{ [key: number]: string }>({});

  const questions = [
    {
      q: "I ___ been reading this book for two hours.",
      options: ["have", "has", "am"],
      correct: "have",
    },
    {
      q: "She ___ been working here since 2015.",
      options: ["have", "has", "is"],
      correct: "has",
    },
    {
      q: "They ___ been playing football all morning.",
      options: ["have", "has", "are"],
      correct: "have",
    },
    {
      q: "We ___ been studying English for three years.",
      options: ["have", "has", "is"],
      correct: "have",
    },
    {
      q: "He ___ been talking on the phone for 30 minutes.",
      options: ["have", "has", "am"],
      correct: "has",
    },
  ];
  ...
  return (
    <section>
      <h2 className="text-2xl font-semibold mb-2 text-blueCl">
        ✍️ Практика — Present Perfect Continuous
      </h2>
      <p className="dark:text-bgLight/70 mb-4">
        Выбери правильную форму <b>have/has</b> для времени <b>Present Perfect Continuous</b>:
      </p>
