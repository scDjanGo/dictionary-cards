...
export default function Practice_Future_Perfect() {
  const [showAnswers, setShowAnswers] = useState(false);
  const [answers, setAnswers] = useState<{ [key: number]: string }>({});

  const questions = [
    {
      q: "I ___ finished my homework by 8 pm tomorrow.",
      options: ["will have", "will", "have"],
      correct: "will have",
    },
    {
      q: "She ___ visited Paris three times by next year.",
      options: ["will have", "will", "has"],
      correct: "will have",
    },
    {
      q: "They ___ eaten lunch before the meeting starts tomorrow.",
      options: ["will have", "have", "will"],
      correct: "will have",
    },
    {
      q: "We ___ seen that movie by next Friday.",
      options: ["will have", "has", "have"],
      correct: "will have",
    },
    {
      q: "He ___ read the book by the time the exam begins.",
      options: ["will have", "has", "have"],
      correct: "will have",
    },
  ];
  ...
  return (
    <section>
      <h2 className="text-2xl font-semibold mb-2 text-blueCl">
        ✍️ Практика — Future Perfect
      </h2>
      <p className="dark:text-bgLight/70 mb-4">
        Выбери правильную форму <b>will have</b> для времени <b>Future Perfect</b>:
      </p>
