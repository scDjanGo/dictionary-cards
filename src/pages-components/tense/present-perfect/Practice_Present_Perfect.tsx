...
export default function Practice_Present_Perfect() {
  ...
  const questions = [
    ...
    {
      q: "She ___ visited Paris three times.",
      options: ["have", "has", "is"],
      correct: "has",
    },
    {
      q: "They ___ eaten lunch already.",
      options: ["have", "has", "are"],
      correct: "have",
    },
    {
      q: "We ___ seen that movie before.",
      options: ["have", "has", "is"],
      correct: "have",
    },
    {
      q: "He ___ read this book.",
      options: ["have", "has", "am"],
      correct: "has",
    },
  ];
  ...
  return (
    <section>
      <h2 className="text-2xl font-semibold mb-2 text-blueCl">
        ✍️ Практика — Present Perfect
      </h2>
      <p className="dark:text-bgLight/70 mb-4">
        Выбери правильную форму <b>have/has</b> для времени <b>Present Perfect</b>:
      </p>
