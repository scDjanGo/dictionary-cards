...
const First_Conditional_Practice = () => {
  const [exercises, setExercises] = useState<State[]>([
    {
      id: 1,
      sentence: "If it ___ (rain) tomorrow, we ___ (cancel) the picnic.",
      correctAnswer: "rains, will cancel",
      userAnswer: "",
      isCorrect: null,
      hint: "First conditional: If + Present Simple, will + infinitive",
    },
    {
      id: 2,
      sentence: "If you ___ (study) hard, you ___ (pass) the exam.",
      correctAnswer: "study, will pass",
      userAnswer: "",
      isCorrect: null,
      hint: "Реальное условие в будущем - Present Simple в условии, will в результате",
    },
    {
      id: 3,
      sentence: "She ___ (be) angry if you ___ (be) late.",
      correctAnswer: "will be, are",
      userAnswer: "",
      isCorrect: null,
      hint: "Порядок частей может меняться, но структура остается: условие - Present Simple, результат - will",
    },
    {
      id: 4,
      sentence: "If I ___ (have) time, I ___ (call) you.",
      correctAnswer: "have, will call",
      userAnswer: "",
      isCorrect: null,
      hint: "Реальное будущее условие - используем Present Simple после if",
    },
    {
      id: 5,
      sentence: "They ___ (not go) to the beach if it ___ (be) cold.",
      correctAnswer: "won't go, is",
      userAnswer: "",
      isCorrect: null,
      hint: "Отрицательная форма: will not/won't в результате, Present Simple в условии",
    },
    {
      id: 6,
      sentence: "If you ___ (not finish) your work, you ___ (not be able) to go out.",
      correctAnswer: "don't finish, won't be able",
      userAnswer: "",
      isCorrect: null,
      hint: "Отрицание в обеих частях: don't в условии, won't в результате",
    },
    {
      id: 7,
      sentence: "What ___ you ___ (do) if you ___ (lose) your job?",
      correctAnswer: "will, do, lose",
      userAnswer: "",
      isCorrect: null,
      hint: "Вопросительная форма: will стоит перед подлежащим",
    },
    {
      id: 8,
      sentence: "If he ___ (not arrive) soon, we ___ (start) without him.",
      correctAnswer: "doesn't arrive, will start",
      userAnswer: "",
      isCorrect: null,
      hint: "Third person singular: doesn't arrive (not doesn't arrives)",
    },
  ]);
      ...
      <div className="">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-slate-700 dark:text-slate-300 mb-2">
            Тренировка построения предложений в First Conditional
          </p>
          <div className="bg-white/60 dark:bg-bgItem rounded-lg p-4 shadow-md inline-block border border-slate-200 dark:border-slate-700">
            <p className="text-sm text-slate-800 dark:text-slate-200 mb-2">
              <strong>First Conditional</strong> используется для описания реальных ситуаций в будущем
            </p>
              ...
              <div className="bg-slate-50 dark:bg-slate-800 rounded-lg p-6 border border-slate-200 dark:border-slate-700">
                ...
                <div className="flex flex-col items-center space-y-4">
                  <input
                    ...
                    placeholder="введите оба глагола через запятую (например: rains, will cancel)"
                  />
...
export default First_Conditional_Practice;